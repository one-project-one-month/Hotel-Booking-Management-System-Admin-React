  ...
  return (
    <div className="relative h-[90vh]">
      ...
      <div className="h-[70vh] px-5 rounded-md mt-10 shadow-lg ">
        <div className="grid grid-cols-3 gap-5 ">
            ...
            <div>
              ...
              <div className="h-[40px] border-2 rounded-md px-2 py-1 text-center mt-2 cursor-pointer">
      ...
      <div className="absolute bottom-0 right-[35%] flex gap-10">
        ...
        <Button className="bg-green-600 w-[150px] py-5 cursor-pointer hover:bg-green-500">Update</Button>
      </div>
    </div>
  )
}
